...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {Q: fragment, S: host, Y: path, _: port_, ac: protocol, ad: query};
	});
...
var $author$project$Main$Social = F2(
	function (icon, link) {
		return {T: icon, V: link};
	});
var $author$project$Main$init = {
	I: _List_fromArray(
		[
			A2($author$project$Main$Social, 'fab fa-instagram', 'https://instagram.com'),
			A2($author$project$Main$Social, 'fab fa-twitter', 'https://twitter.com/xmvmo')
		])
};
...
var $author$project$Main$viewSocialLink = function (social) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href(social.V)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class(social.T)
							]),
						_List_Nil)
					]))
			]));
};
var $author$project$Main$viewSocialLinks = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$viewSocialLink, model.I));
};
		...
		aE: F2(
			function (message, model) {
				return _Utils_Tuple2(
					A2($author$project$Main$update, message, model),
